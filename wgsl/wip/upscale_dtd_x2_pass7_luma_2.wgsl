...
// Anime4K-v3.2-Upscale-DTD-x2-Luma (Second pass)

@group(0) @binding(0) var input_texture: texture_2d<f32>; // darkened texture (4ch x1)
@group(0) @binding(1) var output_texture: texture_storage_2d<r32float, write>; // luminance output (LINELUMA, 1ch x1)

...
// Anime4K-v3.2-Upscale-DTD-x2-Kernel-Y (SIGMA=0.4)

@group(0) @binding(0) var input_texture: texture_2d<f32>; // source texture (HOOKED, 4ch x1)
@group(0) @binding(1) var mmkernel_texture: texture_2d<f32>; // x-blurred texture (MMKERNEL, 1ch x1)
@group(0) @binding(2) var output_texture: texture_storage_2d<r32float, write>; // output (MMKERNEL, 1ch x1)

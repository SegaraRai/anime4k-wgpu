...
@group(0) @binding(1) var overlay_r_texture: texture_2d<f32>;
@group(0) @binding(2) var overlay_g_texture: texture_2d<f32>;
@group(0) @binding(3) var overlay_b_texture: texture_2d<f32>;

...
@group(0) @binding(0) var sobel_texture: texture_2d<f32>; // X-direction gaussian blur (from pass 4, 1ch HQ=x1, F=x0.5, VF=x0.25)
@group(0) @binding(1) var output_texture: texture_storage_2d<r32float, write>; // Y-direction gaussian blur (1ch HQ=x1, F=x0.5, VF=x0.25)

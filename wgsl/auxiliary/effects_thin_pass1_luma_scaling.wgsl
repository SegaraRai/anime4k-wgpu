...
@group(0) @binding(2) var output_texture: texture_storage_2d<r32float, write>; // luminance output (LINELUMA, 1ch VF=x0.5)
...
fn process(pos: vec2i) {
    ...
    let color = textureSampleLevel(input_texture, input_sampler, uv_pos, 0.0);

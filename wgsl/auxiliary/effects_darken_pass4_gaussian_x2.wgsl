...
@group(0) @binding(0) var kernel_texture: texture_2d<f32>; // Y-direction gaussian blur difference (from pass 3, 1ch HQ=x1, F=x0.5, VF=x0.25)
@group(0) @binding(1) var output_texture: texture_storage_2d<r32float, write>; // secondary X-direction gaussian blur (1ch HQ=x1, F=x0.5, VF=x0.25)

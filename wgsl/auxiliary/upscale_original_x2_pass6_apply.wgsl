...
@group(0) @binding(2) var lumad_texture: texture_2d<f32>; // luminance gradient data (from pass 3, 2ch x2)
@group(0) @binding(3) var lumamm_texture: texture_2d<f32>; // normalized gradient directions (from pass 5, 2ch x2)
@group(0) @binding(4) var output_texture: texture_storage_2d<rgba32float, write>; // upscaled output (4ch x2)

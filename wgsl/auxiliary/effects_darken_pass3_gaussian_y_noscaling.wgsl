...
@group(0) @binding(1) var kernel_texture: texture_2d<f32>; // X-direction gaussian blur (from pass 2, 1ch HQ=x1)
@group(0) @binding(2) var output_texture: texture_storage_2d<r32float, write>; // Y-direction gaussian blur difference (1ch HQ=x1)

...
@group(0) @binding(0) var lumad_texture: texture_2d<f32>; // X-direction gradient (from pass 2, 2ch x2)
@group(0) @binding(1) var output_texture: texture_storage_2d<rg32float, write>; // gradient magnitude and refine (2ch x2)

// Settings
const REFINE_STRENGTH: f32 = 1.0;
